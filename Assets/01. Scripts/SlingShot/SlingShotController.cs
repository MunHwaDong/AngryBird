...
public class SlingShotController : MonoBehaviour
{
    ...
    private SlingShotAudioSource _slingShotAudio;
    ...
    void Awake()
    {
        ...
        _slingShotAudio = GetComponentInChildren<SlingShotAudioSource>();
    ...
    void Init(Dragable drag)
    {
        ...
        _bird.OnChangeBird += UpdateRubberband;
        _bird.OnShot += OscillationBand;
        
        _slingShotAudio.Init(drag);
    }
